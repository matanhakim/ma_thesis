...
I consider making a "special sector" variable of some sort, to also include Haredi and Druze. Should it be another variable or added to the sector variable?
```{r}
df <- df %>% 
  mutate(
