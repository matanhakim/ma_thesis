...
df_gini <- df |> 
  summarise(
    ...
    gini_3 = gini_weighted(budget_approved_culture_per_capita, weights = as.integer(pop)),
    ...
    top10_pct_3 = top_prop(budget_approved_culture_per_capita, weights = as.integer(pop), top_prop = 0.1),
    bot50_pct = 1 - top_prop(budget_approved_culture_per_capita, weights = as.integer(pop), top_prop = 0.5),
    mid50_90_pct = 1 - top10_pct_3 - bot50_pct
  )
```
...
df_gini |> 
  ...
  ggplot(aes(year, value, color = statistic)) +
  geom_line()
