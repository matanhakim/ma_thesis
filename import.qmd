...
This function takes a data frame, usually of some budget, and adds the municipality id for every tax id in the budget. Right now the function is succesful for municipalities and amutot, but it also needs data for business companies. after this is achieved, another function needs to be built to summarize the budget data per municipality.
